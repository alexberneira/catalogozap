    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <div className="mb-8">
            ...
            <div className="mb-6">
              <h1 className="text-5xl md:text-6xl font-black text-slate-900 mb-6 leading-tight">
                Seu catálogo online pronto em 5 minutos — pare de perder vendas no WhatsApp
              </h1>
              <p className="text-xl md:text-2xl text-slate-600 mb-8 max-w-3xl mx-auto">
                Transforme conversas em pedidos! Crie grátis, compartilhe o link e receba pedidos direto no WhatsApp. Sem complicação, sem cartão de crédito.
              </p>
            </div>
          </div>
          ...
          {/* Prova social */}
          <div className="mb-4">
            <p className="text-base text-green-700 font-semibold">Mais de 3.000 pequenos negócios já criaram seu catálogo aqui</p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center items-center">
            ...
            <div className="text-xs text-gray-500 mt-2 sm:mt-0 text-center w-full sm:w-auto">
              Totalmente grátis até 3 produtos. Não precisa de cartão de crédito.
            </div>
            <Link
              href="/demo"
          ...
          <div className="mb-12 flex flex-col items-center">
            <div className="bg-white rounded-xl shadow-lg px-6 py-4 inline-block">
              <div className="text-lg font-semibold text-slate-900 mb-2 text-center">Como funciona:</div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Monte seu catálogo em minutos, mesmo sem experiência.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Botão direto para WhatsApp</h3>
            <p className="text-gray-600">
              Cada produto tem um botão de pedido automático. Seus clientes falam com você na hora.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Funciona em qualquer celular</h3>
            <p className="text-gray-600">
              Seu catálogo abre rápido e bonito em qualquer aparelho.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-12 text-center">
            Não fique para trás — comece a vender mais hoje mesmo!
          </h2>
          <p className="text-gray-600 mb-6">
            Em poucos minutos, seu catálogo estará online e pronto para receber pedidos. Milhares de vendedores já estão vendendo mais com o Catálogo Público. O próximo pode ser você!
          </p>
          <Link
            href="/register"
          ...
          <div className="text-xs text-gray-500 mt-2">
            Plano gratuito até 3 produtos. Sem cartão de crédito.
          </div>
        </div>
      </main>
    </div>
